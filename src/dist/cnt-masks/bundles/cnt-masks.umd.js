(function (global, factory) {
...
}(this, (function (exports, i0, angular2TextMask, common, forms, textMaskCore) { 'use strict';
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(CardExpirationPipe, [{
                type: i0.Pipe,
                args: [{
                        name: 'cardExpiration',
                    }]
    ...
    ***************************************************************************** */
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(CCCvcFormatDirective, [{
                type: i0.Directive,
                args: [{
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(CCExpiryFormatDirective, [{
                type: i0.Directive,
                args: [{
    ...
    CCNumberFormatDirective.ɵdir = i0.ɵɵdefineDirective({ type: CCNumberFormatDirective, selectors: [["", "cntMaskCCNum", ""]], hostBindings: function CCNumberFormatDirective_HostBindings(rf, ctx) {
            if (rf & 1) {
                i0.ɵɵlistener("keypress", function CCNumberFormatDirective_keypress_HostBindingHandler($event) { return ctx.onKeypress($event); });
            }
        } });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(CCNumberFormatDirective, [{
                type: i0.Directive,
                args: [{
    ...
    PhoneMaskDirective.ɵfac = function PhoneMaskDirective_Factory(t) { return new (t || PhoneMaskDirective)(i0.ɵɵdirectiveInject(i0.Renderer2), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i0.PLATFORM_ID), i0.ɵɵdirectiveInject(forms.COMPOSITION_BUFFER_MODE, 8)); };
    PhoneMaskDirective.ɵdir = i0.ɵɵdefineDirective({ type: PhoneMaskDirective, selectors: [["", "cntMaskPhone", ""]], hostBindings: function PhoneMaskDirective_HostBindings(rf, ctx) {
            if (rf & 1) {
        ...
        }, inputs: { clean: "clean", maxNumberLength: "maxNumberLength" }, exportAs: ["cntMaskPhone"], features: [i0.ɵɵProvidersFeature([
                {
                    ...
                    useExisting: i0.forwardRef(function () { return PhoneMaskDirective; }),
                },
            ]), i0.ɵɵNgOnChangesFeature] });
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(PhoneMaskDirective, [{
                type: i0.Directive,
                args: [{
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(PhoneMaskPipe, [{
                type: i0.Pipe,
                args: [{
                        name: 'cntMaskPhone',
                    }]
    ...
    CntMasksModule.ɵinj = i0.ɵɵdefineInjector({ factory: function CntMasksModule_Factory(t) { return new (t || CntMasksModule)(); }, providers: [CardExpirationPipe, PhoneMaskPipe], imports: [[angular2TextMask.TextMaskModule]] });
    (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(CntMasksModule, { declarations: [CCNumberFormatDirective,
                CCExpiryFormatDirective,
                CCCvcFormatDirective,
                CardExpirationPipe,
                PhoneMaskDirective,
                PhoneMaskPipe], imports: [angular2TextMask.TextMaskModule], exports: [CCNumberFormatDirective,
                CCExpiryFormatDirective,
                CCCvcFormatDirective,
                CardExpirationPipe,
                PhoneMaskDirective,
    ...
    /*@__PURE__*/ (function () {
        i0.ɵsetClassMetadata(CntMasksModule, [{
                type: i0.NgModule,
                args: [{
