import { ɵɵdefinePipe, ɵsetClassMetadata, Pipe, ɵɵdirectiveInject, ElementRef, ɵɵdefineDirective, Directive, Renderer2, ɵɵlistener, HostListener, PLATFORM_ID, ɵɵProvidersFeature, forwardRef, ɵɵNgOnChangesFeature, Inject, Optional, Input, ɵɵdefineNgModule, ɵɵdefineInjector, ɵɵsetNgModuleScope, NgModule } from '@angular/core';
...
CardExpirationPipe.ɵpipe = ɵɵdefinePipe({ name: "cardExpiration", type: CardExpirationPipe, pure: true });
/*@__PURE__*/ (function () { ɵsetClassMetadata(CardExpirationPipe, [{
        type: Pipe,
        args: [{
                name: 'cardExpiration',
            }]
...
CCCvcFormatDirective.ɵfac = function CCCvcFormatDirective_Factory(t) { return new (t || CCCvcFormatDirective)(ɵɵdirectiveInject(ElementRef)); };
CCCvcFormatDirective.ɵdir = ɵɵdefineDirective({ type: CCCvcFormatDirective, selectors: [["", "cntMaskCCCvc", ""]] });
/*@__PURE__*/ (function () { ɵsetClassMetadata(CCCvcFormatDirective, [{
        type: Directive,
        args: [{
...
CCExpiryFormatDirective.ɵfac = function CCExpiryFormatDirective_Factory(t) { return new (t || CCExpiryFormatDirective)(ɵɵdirectiveInject(ElementRef)); };
CCExpiryFormatDirective.ɵdir = ɵɵdefineDirective({ type: CCExpiryFormatDirective, selectors: [["", "cntMaskCCExp", ""]] });
/*@__PURE__*/ (function () { ɵsetClassMetadata(CCExpiryFormatDirective, [{
        type: Directive,
        args: [{
...
CCNumberFormatDirective.ɵfac = function CCNumberFormatDirective_Factory(t) { return new (t || CCNumberFormatDirective)(ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ElementRef)); };
CCNumberFormatDirective.ɵdir = ɵɵdefineDirective({ type: CCNumberFormatDirective, selectors: [["", "cntMaskCCNum", ""]], hostBindings: function CCNumberFormatDirective_HostBindings(rf, ctx) { if (rf & 1) {
        ɵɵlistener("keypress", function CCNumberFormatDirective_keypress_HostBindingHandler($event) { return ctx.onKeypress($event); });
    } } });
/*@__PURE__*/ (function () { ɵsetClassMetadata(CCNumberFormatDirective, [{
        type: Directive,
        args: [{
                selector: '[cntMaskCCNum]',
            }]
    }], function () { return [{ type: Renderer2 }, { type: ElementRef }]; }, { onKeypress: [{
            type: HostListener,
            args: ['keypress', ['$event']]
        }] }); })();
...
PhoneMaskDirective.ɵfac = function PhoneMaskDirective_Factory(t) { return new (t || PhoneMaskDirective)(ɵɵdirectiveInject(Renderer2), ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(COMPOSITION_BUFFER_MODE, 8)); };
PhoneMaskDirective.ɵdir = ɵɵdefineDirective({ type: PhoneMaskDirective, selectors: [["", "cntMaskPhone", ""]], hostBindings: function PhoneMaskDirective_HostBindings(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { clean: "clean", maxNumberLength: "maxNumberLength" }, exportAs: ["cntMaskPhone"], features: [ɵɵProvidersFeature([
            {
                multi: true,
...
/*@__PURE__*/ (function () { ɵsetClassMetadata(PhoneMaskDirective, [{
        type: Directive,
        args: [{
...
PhoneMaskPipe.ɵpipe = ɵɵdefinePipe({ name: "cntMaskPhone", type: PhoneMaskPipe, pure: true });
/*@__PURE__*/ (function () { ɵsetClassMetadata(PhoneMaskPipe, [{
        type: Pipe,
        args: [{
                name: 'cntMaskPhone',
            }]
...
CntMasksModule.ɵmod = ɵɵdefineNgModule({ type: CntMasksModule });
CntMasksModule.ɵinj = ɵɵdefineInjector({ factory: function CntMasksModule_Factory(t) { return new (t || CntMasksModule)(); }, providers: [CardExpirationPipe, PhoneMaskPipe], imports: [[TextMaskModule]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵɵsetNgModuleScope(CntMasksModule, { declarations: [CCNumberFormatDirective,
        ...
        PhoneMaskDirective,
        PhoneMaskPipe] }); })();
/*@__PURE__*/ (function () { ɵsetClassMetadata(CntMasksModule, [{
        type: NgModule,
        args: [{
