...
export declare class PhoneMaskDirective implements ControlValueAccessor, OnChanges, OnInit {
     ...
     */
    private isAndroid;
    static ɵfac: i0.ɵɵFactoryDef<PhoneMaskDirective, [null, null, null, { optional: true; }]>;
    static ɵdir: i0.ɵɵDirectiveDefWithMeta<PhoneMaskDirective, "[cntMaskPhone]", ["cntMaskPhone"], { "clean": "clean"; "maxNumberLength": "maxNumberLength"; }, {}, never>;
}
